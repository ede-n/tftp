...
/**
 * todo: RRQ and WRQ packets have just one difference- the type, which can be abstracted out.
 *
 * @author nede
 */
@Immutable
        ...
        extends TftpPacket
{
    ...
    private static final Type TYPE = Type.WRQ;
    ...
    public WRQ(String fileName, @Null Mode mode)
    {
        super(TYPE, (mode == null) ? Mode.NETASCII : mode);
        this.fileName = checkNotNull(fileName, "fileName must be non-null.");
    }
    ...
    public static WRQ fromRawPacket(byte[] packet)
    {
